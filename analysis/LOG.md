...
- Added solidus-targeted (2750C) V-sweep search with bisection on Ta: trajectory_search/landing/search_nbta_v_solidus_density.py.
- Generated trajectory_search/landing/search_results_solidus_density.csv and computed properties + phase fractions + THCD:
  trajectory_search/landing/search_results_solidus_density_with_props.csv.
- Added compute helper: trajectory_search/landing/compute_props_and_phases_solidus_density.py.
## 2026-02-04T18:49:00Z
- Added RT (25C) THCD to trajectory_search/landing/search_results_solidus_density_with_props.csv via:
  trajectory_search/landing/add_thcd_rt_to_solidus_density.py.
